...
#ggsave(plot = n15_versus_turb_plots_with_pp_insets, filename = "../outputs/figures/figure1.tif", 
...
print(acan_poo_muscle_n15_size_mod_c_no_out_nest)
pp_check(acan_poo_muscle_n15_size_mod_c_no_out_nest)
plot(acan_poo_muscle_n15_size_mod_c_no_out_nest, ask  = FALSE)
#looks good 

hypothesis(acan_poo_muscle_n15_size_mod_c_no_out_nest, "Muscle_N15_c>0") #1*****
...
steg_23_turb_dat_no_out_c2%>%
  ...
  geom_point(data = acan_23_turb_dat_no_out_c2, aes(pch = "Surgeonfish", color = "Surgeonfish"), size = 2)+
  geom_point(aes(pch = "Damselfish", color = "Damselfish"), size = 2)+
  scale_color_manual(values = poo_colors, name = "")+
    scale_shape_manual(values = shape, name = "")+
    ylab(expression(Fecal~italic(delta)^15*N)) +
...
###Posterior densities for stegastes - n15 
  stat_halfeye(data = as_draws_df(steg_poo_muscle_n15_size_mod_c_no_out_nest), aes(x = b_Muscle_N15_c,  y = 1.1, fill = "Damselfish", color = "Damselfish", pch = "Damselfish"), 
               point_interval=NULL,  slab_alpha = .3) + 
  ##posterior densites for Atri:
  stat_halfeye(data = as_draws_df(acan_poo_muscle_n15_size_mod_c_no_out_nest), aes(x = b_Muscle_N15_c,  y = 1, fill = "Surgeonfish", color = "Surgeonfish", pch = "Surgeonfish"), 
               point_interval=NULL,  slab_alpha = .5) + 
  ...
  #slab outline stegastes:
    ...
    #slab outline acan:
    stat_halfeye(data = as_draws_df(acan_poo_muscle_n15_size_mod_c_no_out_nest), aes(x = b_Muscle_N15_c,  y = 1), point_interval = NULL,  slab_fill = NA, outline_bars = TRUE, slab_color = "#88CCEE",   slab_linewidth = .5 ) + 
  
  
  #intervals acan:
   stat_halfeye(data = as_draws_df(acan_poo_muscle_n15_size_mod_c_no_out_nest), aes(x = b_Muscle_N15_c,  y = 1, fill = "Surgeonfish", color = "Surgeonfish"), 
