...
###------------GROWTH - CHANGED APPROACH, SEE VBGF_R1 FILE-----------------
...
ggsave(plot = dem_plots_1, filename = "../outputs/figures/fecal_plots_dem_supp_R1.tif", 
       width  = 1961, height = 2700, units = "px")



##now save muscle ones:-----
#**Growth from other file
...
ggsave(plot = dem_plots_musc_1, filename = "../outputs/figures/figure3_R1.tif", 
       width  = 1961, height = 2700, units = "px")
